...
import EditCryptoInWalletTemplate from "../panel/EditCryptoInWalletTemplate";
import { toast } from "react-toastify";

import { walletsEdit, walletsDeleteCrypto } from "../slices/WalletsSlice";

const EditWalletTemplate = () => {

    const { editStatus } = useSelector((state) => state.wallets);
    ...
    const handleView = (cryptoName) => {
        navigate(`/wallet/view-crypto/${walletName}/${cryptoName}`);
    };

    const handleEdit = (cryptoName) => {
        ...
        <StyledWallet>
            <WalletContainer>
                {loading ? (<p>Loading...</p>) :
                      ...
                      <WalletDetails >
                        <h3>Edit Wallet: {wallet.walletName}</h3>
                        <input
                          type="text"
                        ...
                        <CryptoCountDiv>
                          ...
                          <AddButton
                              onClick={() => navigate(`/wallet/create-crypto/${walletName}`)}
                              >
                                  Add Crypto
                              </AddButton>
...
export default EditWalletTemplate;
